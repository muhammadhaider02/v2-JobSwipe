...
const blobConfigs = [
  {
    size: 'w-[350px] h-[350px] md:w-[700px] md:h-[700px]',
  ...
  {
    size: 'w-[280px] h-[280px] md:w-[600px] md:h-[600px]',
  ...
  return (
    ...
    >
      {blobConfigs.map((blob, i) => (
        <motion.div
          key={i}
          className={`absolute ${blob.size} ${blob.position} rounded-full bg-gradient-to-br ${isDark ? blob.dark : blob.light} blur-[60px] md:blur-[100px]`}
          animate={{
            x: [0, 30, -20, 10, 0],
            y: [0, -20, 30, -10, 0],
