...
class CoverLetterService:
    ...
    def __init__(self, supabase_service: SupabaseService | None = None):
        ...
        self.supabase = supabase_service or SupabaseService(use_service_role=False)
    ...
    def generate_cover_letter(self, user_id: str, job_id: str, template_name: str) -> str:
        ...
        """
        # Fetch data
        user_profile = self.supabase.fetch_user_profile(user_id)
        job = self.supabase.fetch_job_by_id(job_id)
