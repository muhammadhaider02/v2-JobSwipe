...
def get_learning_resources():
    ...
    try:
        ...
        logger.info(
            "Learning resources requested: skills=%s, google=%d, youtube=%d",
            skills, num_google, num_youtube,
        )
        ...
        logger.info("Learning resources generated: skills_processed=%d", len(skill_resources))
        ...
        logger.error("Error generating learning resources: %s", e, exc_info=True)
